<template>
    <div class="pointer-events-none fixed inset-x-0 z-30 bottom-0 sm:px-6 sm:pb-5 lg:px-8">
  <div class="pointer-events-auto flex items-center justify-between gap-x-6 bg-green-500 px-6 py-2.5 sm:rounded-xl sm:py-3 sm:pl-4 sm:pr-3.5">
